...
//                             grille.tableauJeu[ship.getX()][(ship.getY() + 1)] = ship.getVisuel();
...
//                             grille.tableauJeu[ship.getX()][(ship.getY() - ship.getTaille())] = ship.getVisuel();
//                             ship.setY(ship.getY() -1);
...
//                         grille.tableauJeu[ship.getX() - 1][ship.getY()] = ship.getVisuel();
...
//                         grille.cacherCaseGrille(ship.getX(), ship.getY());
//                         grille.tableauJeu[ship.getX() + ship.getTaille()][ship.getY()] = ship.getVisuel();
//                         ship.setX(ship.getX() + 1);
